...
__all__ = [
    'DISPID_SVStatus', 'SPVISEMES', 'SVPAlert',
    'DISPID_SPELexicalForm', 'SPEI_UNDEFINED',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechPhraseReplacements',
    'SpMemoryStream', 'SAFTCCITT_ALaw_11kHzStereo',
    'SECFNoSpecialChars', 'SAFT44kHz16BitStereo', 'SPCT_DICTATION',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPEDisplayAttributes',
    'SPEI_RESERVED6', 'DISPID_SPAsItem', 'SVF_Emphasis',
    'DISPID_SVGetVoices', 'SpeechFormatType', 'DISPID_SVEBookmark',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechRecoContextState',
    'DISPID_SLWType', 'SPFM_CREATE', 'SAFTADPCM_8kHzStereo',
    'DISPID_SpeechMMSysAudio', 'SECNormalConfidence', 'SPPS_LMA',
    'DISPID_SGRSTRule', 'DISPID_SVEStreamStart',
    'DISPID_SVSLastResult', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPERequiredConfidence', 'DISPID_SGRSRule',
    'SVESentenceBoundary', 'DISPID_SPRuleFirstElement',
    'ISpeechRecognizerStatus', 'SpeechTokenKeyFiles',
    'DISPID_SVGetAudioOutputs', 'SPPS_Unknown', 'SPGRAMMARSTATE',
    'DISPID_SPACommit', 'DISPID_SPRulesItem', 'SRAImport',
    'SPEI_MIN_SR', 'SpeechGrammarTagWildcard', 'DISPID_SGRsItem',
    'SVSFParseAutodetect', 'SECLowConfidence', 'SPBINARYGRAMMAR',
    'DISPID_SRGSetTextSelection', 'SRESoundStart', 'SRAONone',
    'DISPID_SVSRunningState', 'DISPID_SpeechPhraseProperties',
    'SAFT32kHz16BitMono', 'SPAUDIOSTATUS', 'SREStreamStart',
    'SpeechVoicePriority', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPAUDIOBUFFERINFO', 'SSSPTRelativeToEnd', 'DISPID_SPIRule',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRSAudioStatus',
    'DISPID_SASNonBlockingIO', 'STCRemoteServer',
    'DISPID_SLPPartOfSpeech', 'SP_VISEME_11', 'ISpGrammarBuilder',
    'DISPID_SVAudioOutputStream', 'DISPID_SPCIdToPhone',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechRunState', 'SPAS_CLOSED',
    'SBOPause', 'DISPID_SVSpeakCompleteEvent', 'DISPID_SBSSeek',
    'IStream', 'eLEXTYPE_MORPHOLOGY', 'SRTStandard',
    'DISPID_SDKOpenKey', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPPBRestorePhraseFromMemory', 'tagSPTEXTSELECTIONINFO',
    'STCInprocHandler', 'SAFT11kHz8BitMono', 'eLEXTYPE_RESERVED9',
    'SVP_8', 'SAFTCCITT_ALaw_8kHzStereo', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPRsCount', 'SPSVerb',
    'SAFTCCITT_uLaw_8kHzStereo', 'eLEXTYPE_RESERVED4',
    'SPPS_RESERVED2', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SpeechLexiconWords', 'SPEI_RESERVED5', 'DISPID_SVEViseme',
    'SDKLCurrentConfig', 'DISPID_SRGDictationSetState',
    'SP_VISEME_20', 'DISPID_SPCPhoneToId', 'eLEXTYPE_PRIVATE16',
    'DISPID_SRCEFalseRecognition', 'SGSDisabled', 'SP_VISEME_2',
    'STSF_CommonAppData', 'SpeechTokenContext',
    'DISPID_SpeechDataKey', 'SDTAudio', 'SpStreamFormatConverter',
    'SPVPRI_NORMAL', 'SP_VISEME_19', 'DISPID_SRGRules',
    'DISPID_SAEventHandle', 'SpeechPropertyAdaptationOn',
    'DISPID_SRRSpeakAudio', 'SP_VISEME_0', 'DISPID_SpeechFileStream',
    'SDKLDefaultLocation', 'eLEXTYPE_RESERVED8', 'SRSEIsSpeaking',
    'SPGS_EXCLUSIVE', 'SWTDeleted', 'DISPID_SRCEAudioLevel',
    ...
    'DISPID_SPRNumberOfElements', 'SGRSTTWord', 'SAFT48kHz8BitStereo',
    'DISPID_SpeechRecoResult', 'SPXRO_Alternates_SML', 'DISPIDSPTSI',
    'DISPID_SCSBaseStream', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SVIsUISupported', 'SpeechAudioFormatGUIDWave',
    'DISPID_SLPSymbolic', 'SpeechStreamSeekPositionType',
    'SPSUnknown', 'SpeechAudioVolume', 'SPSHORTCUTPAIRLIST',
    'SPSNotOverriden', 'SPSHT_NotOverriden',
    'SpTextSelectionInformation', 'SPEI_RECO_OTHER_CONTEXT',
    'WAVEFORMATEX', 'DISPID_SAFType', 'DISPID_SRAudioInputStream',
    'SRTAutopause', 'SPSEMANTICFORMAT', 'DISPID_SLWsCount', 'SVP_21',
    'SPRECORESULTTIMES', 'ISpeechResourceLoader',
    'DISPID_SRGSetWordSequenceData', 'SPSHORTCUTPAIR',
    'DISPID_SpeechLexiconWord', 'SAFT24kHz8BitStereo', 'SpMMAudioIn',
    'DISPID_SOTDataKey', 'SVP_0', 'ISpeechRecoResult',
    'SPLEXICONTYPE', 'SPDKL_LocalMachine', 'SPBO_NONE',
    'DISPID_SWFESamplesPerSec', 'DISPID_SOTCategory',
    'SPPARTOFSPEECH', 'SPEVENTSOURCEINFO', 'SPSFunction',
    'DISPID_SOTSetId', 'DISPID_SFSOpen', 'ISpEventSink',
    'SPEI_SR_BOOKMARK', 'SPEI_HYPOTHESIS', 'SVSFNLPMask',
    'SpeechPropertyResourceUsage', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechRecoResultTimes', '__MIDL_IWinTypes_0009',
    'tagSPPROPERTYINFO', 'SDTLexicalForm', 'ISpXMLRecoResult',
    'SPEI_RESERVED2', 'DISPID_SPIGrammarId', 'SREHypothesis',
    'SPWORDTYPE', 'SPSMF_SRGS_SAPIPROPERTIES', 'SREPropertyNumChange',
    'DISPID_SpeechPhraseElement', 'DISPID_SASState', 'SITooLoud',
    'SRSEDone', 'SPWT_DISPLAY', 'SPVPRI_OVER',
    'DISPID_SRCSetAdaptationData', 'SRESoundEnd',
    'SPWORDPRONOUNCEABLE', 'Speech_Default_Weight', 'SVEWordBoundary',
    'SAFT32kHz8BitStereo', 'SPWT_LEXICAL', 'DISPID_SpeechVoice',
    'DISPID_SLRemovePronunciation', 'DISPID_SLWs_NewEnum',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRCEStartStream',
    'SSSPTRelativeToStart', 'DISPID_SOTGetStorageFileName',
    'SPCATEGORYTYPE', 'SpNullPhoneConverter', 'DISPID_SGRName',
    'SPEI_REQUEST_UI', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRRRecoContext', 'SRERecognition', 'SPEI_MAX_SR',
    'SPVOICESTATUS', 'SAFT16kHz16BitMono', 'ISpeechPhraseAlternates',
    'DISPID_SVAlertBoundary', 'ISpeechPhraseReplacements',
    'SPPHRASEPROPERTY', 'SVP_3', 'SP_VISEME_14',
    'DISPID_SWFEChannels', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRCERequestUI', 'SVP_12', 'eLEXTYPE_PRIVATE13',
    'DISPID_SAVolume', 'SAFT32kHz16BitStereo',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPEsItem',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SpeechLexiconPronunciation',
    'SITooQuiet', 'SPSTREAMFORMATTYPE', 'SVP_16', 'DISPID_SRGCommit',
    'SPFM_OPEN_READWRITE', 'SPPS_RESERVED4', 'SASStop',
    'SRAInterpreter', 'DISPID_SPPsItem', 'SPAUDIOOPTIONS',
    'SPCONTEXTSTATE', 'SPPS_RESERVED1', 'DISPID_SRCEBookmark',
    'SVF_Stressed', 'DISPID_SPRDisplayAttributes',
    'ISpeechLexiconWords', 'SpeechInterference', 'SAFT8kHz16BitMono',
    'eWORDTYPE_DELETED', 'SINoSignal',
    'DISPID_SRSCurrentStreamNumber', 'SPINTERFERENCE_TOOSLOW',
    'SGRSTTDictation', 'SAFT24kHz16BitMono', 'SECFIgnoreKanaType',
    'SPAO_RETAIN_AUDIO', 'SASClosed', 'SpInprocRecognizer', 'SVP_17',
    'DISPID_SLGetWords', 'DISPID_SAFGuid', 'DISPID_SLWWord',
    'DISPID_SVVolume', 'SpeechVoiceSpeakFlags', 'SP_VISEME_16',
    'eLEXTYPE_PRIVATE18', 'SRTEmulated', 'DISPID_SRIsShared',
    'DISPID_SOTMatchesAttributes', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpPhoneticAlphabetConverter', 'DISPID_SpeechBaseStream',
    'SpeechVoiceCategoryTTSRate',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SVDisplayUI',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SPPName', 'SPRECOGNIZERSTATUS',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechCustomStream', 'SREBookmark',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRCEInterference', 'SpeechAudioFormatGUIDText',
    'SPEI_SR_RETAINEDAUDIO', 'SpAudioFormat', 'SpeechAddRemoveWord',
    'SRSInactive', 'ISpeechXMLRecoResult', 'SECFIgnoreCase',
    'SAFT48kHz8BitMono', 'Speech_Max_Pron_Length', 'SpPhoneConverter',
    'DISPID_SRCRetainedAudio', 'SpeechVisemeFeature', 'ISpShortcut',
    'SPBO_AHEAD', 'SPINTERFERENCE_NONE',
    ...
    'DISPID_SPPEngineConfidence', 'Speech_StreamPos_RealTime',
    'SPCT_COMMAND', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVAudioOutput', 'DISPID_SOTsItem', 'UINT_PTR',
    'SPEI_INTERFERENCE', 'eLEXTYPE_PRIVATE15', 'SRAORetainAudio',
    'SPFILEMODE', 'SPEI_PHRASE_START', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFTADPCM_8kHzMono', 'IEnumSpObjectTokens',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SABufferNotifySize',
    'ISpeechMemoryStream', 'ISpeechMMSysAudio', 'SP_VISEME_10',
    'SpeechWordType', 'SPAO_NONE', 'DISPID_SPIElements',
    'SPPS_NotOverriden', 'DISPID_SRGRecoContext', 'SVSFIsFilename',
    'DISPID_SRRAlternates', 'DISPID_SPEAudioTimeOffset',
    'SpeechRuleState', 'eLEXTYPE_PRIVATE3', 'SPEI_VISEME',
    'SAFT22kHz16BitStereo', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SOTGetAttribute', 'DISPID_SPAPhraseInfo',
    'SpeechGrammarTagUnlimitedDictation', 'eLEXTYPE_RESERVED6',
    'DISPID_SVSPhonemeId', 'SpeechEngineConfidence', 'SGRSTTRule',
    'SVEViseme', 'DISPID_SpeechRecoContextEvents', 'DISPID_SRProfile',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTDisplayUI', 'ISpRecognizer',
    'SLOStatic', 'SVP_7', 'eLEXTYPE_APP', 'eLEXTYPE_PRIVATE17',
    'SPSERIALIZEDPHRASE', 'DISPID_SpeechGrammarRule', 'SPSLMA',
    'DISPID_SPEActualConfidence', 'SpLexicon', 'ISpeechGrammarRules',
    'DISPID_SLPsItem', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRRTTickCount', 'DISPID_SRCCreateResultFromMemory',
    'SVEEndInputStream', 'DISPID_SLPs_NewEnum',
    'ISpeechRecoResultTimes', 'SpMMAudioEnum', 'DISPID_SRCEEndStream',
    'DISPID_SVSInputSentencePosition', 'SpWaveFormatEx',
    'DISPID_SRSSupportedLanguages', 'SWPUnknownWordUnpronounceable',
    'SSFMOpenReadWrite', 'DISPID_SMSADeviceId',
    'SAFT24kHz16BitStereo', 'SAFT8kHz8BitStereo',
    'DISPID_SWFEAvgBytesPerSec', 'SAFTGSM610_11kHzMono',
    'DISPID_SMSAMMHandle', 'DISPID_SPPValue', 'SPCS_ENABLED',
    'SREAllEvents', 'SAFT22kHz16BitMono', 'DISPID_SRCEAdaptation',
    'SpPhraseInfoBuilder', 'SVSFIsXML', 'SVPOver', 'SSFMCreate',
    'DISPID_SRDisplayUI', 'ISpeechRecognizer',
    'SGLexicalNoSpecialChars', 'DISPID_SRIsUISupported',
    'SAFTADPCM_11kHzMono', 'SP_VISEME_18', 'SpSharedRecognizer',
    'eLEXTYPE_RESERVED7', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCPause', '_ISpeechVoiceEvents', 'SFTInput',
    'DISPID_SOTRemove', 'SASRun', 'ISpeechPhraseRules',
    'SpeechDiscardType', 'DISPID_SPAs_NewEnum',
    'SPEI_START_SR_STREAM', 'eLEXTYPE_USER',
    'DISPID_SVSLastStreamNumberQueued', 'eLEXTYPE_PRIVATE1',
    'SVSFVoiceMask', 'SpeechCategoryAudioIn', 'DISPID_SRCRecognizer',
    'DISPID_SABufferInfo', 'DISPID_SVSLastBookmark', 'SP_VISEME_8',
    'SP_VISEME_12', 'SAFT12kHz16BitStereo', 'SAFT22kHz8BitStereo',
    ...
    'ISpeechRecoResultDispatch', 'ISpPhraseAlt', 'SPLO_STATIC',
    'SECFDefault', 'SAFTCCITT_ALaw_8kHzMono', 'SP_VISEME_9',
    'SpeechVisemeType', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPRuleParent', 'DISPID_SPRFirstElement', 'SPINTERFERENCE',
    'SRSInactiveWithPurge', 'SPSModifier', 'ISpeechVoiceStatus',
    'DISPID_SVSLastBookmarkId', 'DISPID_SDKEnumValues',
    'DISPID_SAStatus', 'DISPID_SVPriority', 'SP_VISEME_7',
    'SFTSREngine', 'SPPHRASERULE', 'ISpeechVoice',
    'SAFT44kHz8BitStereo', 'SPEI_FALSE_RECOGNITION',
    'SECHighConfidence', 'STSF_AppData', 'eLEXTYPE_PRIVATE9',
    'DISPID_SVSVisemeId', 'DISPID_SRCRequestedUIType',
    'ISpeechLexiconPronunciation', 'SPPS_Modifier',
    'DISPID_SpeechVoiceEvent', 'SPPHRASE', 'SPDATAKEYLOCATION',
    'DISPID_SVGetProfiles', 'ISpeechGrammarRuleState', 'SVPNormal',
    'ISpeechAudioFormat', 'DISPID_SGRId', 'SAFT11kHz16BitStereo',
    'DISPID_SOTCId', 'DISPID_SLGetGenerationChange', 'SRTSMLTimeout',
    'SpSharedRecoContext', 'SPEVENT', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SDKGetlongValue',
    'DISPID_SPIProperties', 'DISPID_SVVoice',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRRDiscardResultInfo',
    '_ISpeechRecoContextEvents', 'DISPID_SRCEPhraseStart',
    'DISPID_SGRsCount', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseProperty', 'SPRULE', 'SPPHRASEREPLACEMENT',
    ...
    'ISpObjectWithToken', 'SPCT_SLEEP', 'SAFTADPCM_44kHzStereo',
    'SpeechTokenKeyAttributes', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SGRs_NewEnum', 'SAFTCCITT_uLaw_44kHzStereo',
    'SVSFPersistXML', 'SpeechEngineProperties', 'DISPIDSPRG',
    'SPEI_SR_PRIVATE', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRGetPropertyNumber', 'SpeechAllElements',
    'DISPID_SADefaultFormat', 'SPEI_SOUND_END', 'SRSActiveAlways',
    'DISPID_SOTGetDescription', 'DISPID_SPEs_NewEnum',
    'DISPID_SGRSAddWordTransition', 'SDTAll',
    'DISPID_SVEventInterests', 'DISPID_SGRAddState',
    'DISPID_SRGCmdLoadFromFile', 'SPXRO_SML', 'SAFT11kHz16BitMono',
    'SPSHT_OTHER', 'ISpeechLexiconWord',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPAR_Unknown',
    'DISPID_SRCreateRecoContext', 'STCLocalServer',
    'DISPID_SPIStartTime', 'DISPID_SABIBufferSize',
    'SAFT44kHz8BitMono', 'DISPID_SDKSetBinaryValue',
    'DISPID_SDKDeleteKey', 'SDTProperty',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_RESERVED10',
    'SPRST_ACTIVE', 'SPPS_Function', 'DISPID_SLPLangId',
    'DISPIDSPTSI_ActiveOffset',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechObjectTokens',
    'ISpeechLexiconPronunciations', 'DISPID_SPEAudioStreamOffset',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPEAudioSizeBytes',
    'SPPS_RESERVED3', 'DISPID_SABIEventBias',
    'DISPID_SPPNumberOfElements', 'SVEStartInputStream',
    'DISPID_SOTCGetDataKey', 'SpeechPartOfSpeech', 'ISpEventSource',
    'SAFTCCITT_ALaw_22kHzStereo', 'SWTAdded',
    'ISpeechTextSelectionInformation', 'SPADAPTATIONRELEVANCE',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SWFEExtraData',
    'SGRSTTTextBuffer', 'SPBO_TIME_UNITS', 'SpeechVoiceEvents',
    'SPCS_DISABLED', 'SPRST_NUM_STATES',
    'DISPID_SPIGetDisplayAttributes', 'SpeechRetainedAudioOptions',
    'SP_VISEME_1', 'DISPID_SLWPronunciations', 'DISPID_SPCLangId',
    'SDTPronunciation', 'ISpLexicon', 'SSFMCreateForWrite',
    'DISPID_SVEStreamEnd', 'DISPID_SRRAudio', 'ISpeechPhraseInfo',
    'DISPID_SVSpeak', 'DISPID_SOTsCount', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRGetFormat', 'SAFT12kHz8BitStereo', 'ISpeechBaseStream',
    'DISPID_SPIGetText', 'DISPID_SGRInitialState',
    'SpeechPropertyResponseSpeed', 'DISPID_SRRSaveToMemory',
    'SP_VISEME_21', 'DISPID_SRCERecognition', 'SpeechLoadOption',
    'DISPID_SRGIsPronounceable', 'SpeechUserTraining',
    'DISPID_SGRAttributes', 'SPEI_ADAPTATION', 'DISPID_SRCVoice',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRRTLength', 'SREStreamEnd',
    'SVP_2', 'SDTReplacement', 'DISPID_SRRTStreamTime',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRGCmdLoadFromMemory',
    'SPDKL_CurrentConfig', 'SAFT12kHz16BitMono', 'SVP_4',
    'SpeechGrammarState', 'SPSHT_Unknown', 'SDTDisplayText',
    'SRARoot', 'SAFTGSM610_8kHzMono', 'SVSFPurgeBeforeSpeak',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_PRIVATE6',
    'eLEXTYPE_PRIVATE19', 'DISPID_SLWLangId', 'DISPID_SPRuleName',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRCEPropertyStringChange',
    'SPEI_TTS_BOOKMARK', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SBSWrite', 'ISpDataKey', 'ISpRecoGrammar2', 'SPWORD',
    'SPSHORTCUTTYPE', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPPConfidence', 'SpObjectTokenCategory',
    'SPGRAMMARWORDTYPE', 'SRTReSent', 'DISPID_SpeechAudioFormat',
    'DISPID_SDKGetStringValue', 'ISpeechObjectToken',
    'DISPID_SpeechPhraseRules', 'SP_VISEME_4',
    'DISPIDSPTSI_SelectionLength', 'SPEI_START_INPUT_STREAM',
    'DISPID_SVSInputWordPosition', 'SAFT44kHz16BitMono',
    ...
    'ISpRecoResult', 'SVP_5', 'SPPS_Verb', 'tagSTATSTG',
    'SPRS_ACTIVE', 'ISpPhoneConverter', 'SAFT11kHz8BitStereo',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SRGetPropertyString',
    'ISpRecoCategory', 'ISpeechPhraseElement', 'DISPID_SOTId',
    'SVSFNLPSpeakPunc', 'SVSFUnusedFlags', 'SRAExport',
    'SPEI_PHONEME', 'SPAR_Medium', 'SP_VISEME_15',
    'DISPID_SRCVoicePurgeEvent', 'SPLOADOPTIONS',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRRTimes',
    'DISPID_SPILanguageId', 'SPEI_RESERVED1', 'SPBOOKMARKOPTIONS',
    'SPWAVEFORMATTYPE', 'ISpSerializeState', 'SPLO_DYNAMIC',
    'SAFTGSM610_44kHzMono', 'DISPID_SpeechXMLRecoResult', 'SVP_15',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPEI_VOICE_CHANGE',
    'DISPID_SRGetRecognizers', 'ISpeechRecoContext',
    'ISpeechPhraseInfoBuilder', 'DISPID_SVEWord',
    'SPEI_END_SR_STREAM', 'DISPID_SDKSetLongValue', 'SPBO_PAUSE',
    'STCInprocServer', 'SpeechTokenShellFolder',
    'SpeechPropertyNormalConfidenceThreshold', 'SPWT_PRONUNCIATION',
    'SRCS_Disabled', 'SDA_One_Trailing_Space', 'SPVPRIORITY',
    'SAFTADPCM_22kHzMono', 'ISpeechAudioBufferInfo',
    'DISPID_SVSInputWordLength', 'SpeechDisplayAttributes',
    'SPFM_OPEN_READONLY', 'DISPID_SBSFormat',
    'DISPID_SRSCurrentStreamPosition', 'LONG_PTR',
    'DISPID_SpeechLexicon', 'DISPID_SPRuleNumberOfElements',
    'SPWORDLIST', 'SGSExclusive',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVESentenceBoundary', 'DISPIDSPTSI_SelectionOffset',
    'ISpRecognizer2', 'SpCustomStream', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechRecoResult2', 'DISPID_SVEPhoneme',
    'SpeechGrammarTagDictation', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechWordPronounceable', 'SDA_Consume_Leading_Spaces',
    'DISPID_SBSRead', 'ISpMMSysAudio',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SPPs_NewEnum',
    'SPSERIALIZEDRESULT', 'DISPID_SOTCSetId', 'SVEBookmark',
    'SWPUnknownWordPronounceable', 'ISpPhrase', 'ISpeechPhraseRule',
    'SLTUser', 'ISpeechAudioStatus', 'DISPID_SLWsItem', 'SVP_11',
    'DISPID_SGRSTs_NewEnum', 'SVP_9', 'SREPrivate',
    'DISPID_SGRSTPropertyName', 'DISPID_SpeechAudioStatus',
    'DISPID_SRRSetTextFeedback', 'SpFileStream',
    'DISPID_SRCESoundStart', 'DISPID_SLGenerationId', 'SPEI_MAX_TTS',
    'SRSActive', 'DISPID_SRCEHypothesis', 'SVP_19',
    'ISpeechPhraseReplacement', 'ISpStreamFormat', 'DISPID_SPRsItem',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPERetainedSizeBytes',
    'SAFT48kHz16BitMono', 'SAFT24kHz8BitMono', 'SAFT8kHz16BitStereo',
    'DISPID_SDKCreateKey', 'SGDSInactive', 'SVSFParseSapi',
    'DISPID_SRCERecognitionForOtherContext',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SVSpeakStream',
    'DISPID_SASCurrentSeekPosition', 'SAFTADPCM_44kHzMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVP_18', 'SREAudioLevel',
    '_SPAUDIOSTATE', 'ISpeechGrammarRuleStateTransition',
    'SAFT32kHz8BitMono', 'DISPID_SpeechObjectTokenCategory',
    'SAFTNoAssignedFormat', 'SpShortcut',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechGrammarWordType', 'SINoise',
    'DISPID_SVWaitUntilDone', 'ISpeechGrammarRuleStateTransitions',
    'SAFT12kHz8BitMono', 'SpeechDataKeyLocation', 'SVP_1',
    'DISPID_SPEEngineConfidence', 'SpeechCategoryPhoneConverters',
    'DISPID_SpeechRecognizerStatus', 'SDKLCurrentUser',
    'DISPID_SVPause', 'DISPID_SPRuleConfidence', 'STCAll',
    'DISPID_SRRPhraseInfo', 'DISPID_SRGCmdSetRuleState', 'SPAS_STOP',
    'DISPID_SGRSTType', 'SVEPrivate', 'DISPID_SRCState',
    'DISPID_SGRSTPropertyId', 'SITooFast', 'ISpAudio',
    'SPRECOCONTEXTSTATUS', 'ISpVoice', 'DISPID_SPAsCount',
    'SP_VISEME_13', 'SGDSActiveWithAutoPause', 'SP_VISEME_6',
    'SpeechDictationTopicSpelling', 'SPSSuppressWord',
    'SPRST_INACTIVE', 'DISPID_SGRSTNextState',
    'SSSPTRelativeToCurrentPosition', 'ISpRecognizer3', 'SVEPhoneme',
    'SLTApp', 'SVP_20', 'DISPID_SpeechAudio', 'SPCT_SUB_COMMAND',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpNotifySink',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPWF_SRENGINE',
    'SPAS_RUN', 'SREPhraseStart', 'SpStream',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechObjectTokenCategory',
    'SVP_10', 'DISPID_SRState', 'SPAR_Low', 'DISPID_SRStatus',
    'DISPID_SOTIsUISupported', 'DISPID_SpeechGrammarRuleState',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTNonStandardFormat',
    'DISPID_SVEVoiceChange', 'SPXMLRESULTOPTIONS', 'SGDSActive',
    'ISpRecoGrammar', 'SPEI_RECO_STATE_CHANGE', 'ISpProperties',
    'SVSFParseSsml', 'SpeechCategoryRecognizers', 'SVP_6',
    'DISPID_SRGDictationUnload', 'DISPID_SVSkip', 'SREAdaptation',
    'DISPID_SRGState', 'DISPID_SGRsDynamic', 'DISPID_SVEAudioLevel',
    'SREStateChange', 'SpUnCompressedLexicon', 'SpeechAudioState',
    'SpeechAudioProperties', 'SpeechSpecialTransitionType',
    'SPPS_SuppressWord', '_RemotableHandle',
    'DISPID_SDKSetStringValue', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SAFSetWaveFormatEx', 'SLODynamic', 'ISpObjectToken',
    'SRADynamic', 'SP_VISEME_5', 'DISPID_SPEsCount', 'SASPause',
    'SPEI_END_INPUT_STREAM', 'eLEXTYPE_PRIVATE8', 'ISpRecoContext',
    'SBONone', 'DISPID_SRRAudioFormat',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_RESERVED3',
    'ISpeechWaveFormatEx', 'SPDKL_CurrentUser', 'DISPID_SASetState',
    'DISPID_SRSClsidEngine', 'SpeechAudioFormatType', 'SPSNoun',
    'DISPID_SpeechLexiconProns', 'Speech_Max_Word_Length',
    'DISPID_SGRSTransitions', 'SSTTTextBuffer', 'DISPID_SPPId',
    'DISPID_SGRsCommit', 'DISPID_SPRules_NewEnum', 'SGRSTTEpsilon',
    'SpVoice', 'SPPS_Noncontent', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPRulesCount', 'SVSFDefault', 'SAFTDefault',
    'SRERecoOtherContext', 'SVF_None', 'SPAUDIOSTATE',
    'SVEVoiceChange', 'SAFT8kHz8BitMono', 'SPWF_INPUT',
    'DISPID_SVResume', 'eWORDTYPE_ADDED', 'SAFT48kHz16BitStereo',
    'DISPID_SVRate', 'ISpeechPhraseProperty',
    'DISPID_SPISaveToMemory', 'IEnumString',
    ...
    'DISPID_SPRText', 'ISpeechPhraseElements', 'SpeechRuleAttributes',
    'SREInterference', 'DISPID_SpeechMemoryStream',
    'eLEXTYPE_PRIVATE7', 'SPINTERFERENCE_NOISE', 'SECFEmulateResult',
    'DISPID_SRAudioInput', 'SPEVENTENUM', 'SAFTCCITT_ALaw_22kHzMono',
    'SPPROPERTYINFO', 'DISPID_SMSSetData', 'SPAR_High',
    ...
    'ISpPhoneticAlphabetConverter', 'SpMMAudioOut', 'SPRS_INACTIVE',
    'SPSHT_EMAIL', 'SDTAlternates',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEI_TTS_PRIVATE',
    'IInternetSecurityManager', 'DISPID_SpeechRecognizer', 'SINone',
    'ISpStream', 'DISPID_SPPChildren', 'SpeechRecognizerState',
    'SP_VISEME_17', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SLPsCount', 'SGRSTTWildcard', 'SAFT16kHz8BitStereo',
    'eLEXTYPE_PRIVATE4', 'SVSFlagsAsync', 'DISPID_SASFreeBufferSpace',
    'SVEAudioLevel', 'IInternetSecurityMgrSite', 'SPRULESTATE',
    'SRERequestUI', 'STSF_FlagCreate', 'DISPID_SPRuleId',
    'SGDSActiveUserDelimited', 'SPPS_Interjection',
    'DISPID_SWFEFormatTag', 'ISpeechPhraseAlternate',
    'SDA_No_Trailing_Space', 'DISPID_SGRSTText', 'DISPID_SGRsAdd',
    'DISPID_SMSGetData', 'DISPID_SWFEBitsPerSample',
    'DISPID_SPERetainedStreamOffset', 'SPINTERFERENCE_TOOFAST',
    'SpeechBookmarkOptions', 'SRADefaultToActive',
    'SpeechTokenIdUserLexicon', 'SAFTExtendedAudioFormat',
    'SpeechCategoryAudioOut', 'SVSFIsNotXML', 'SPCT_SUB_DICTATION',
    'SPFM_NUM_MODES', 'eLEXTYPE_PRIVATE20', 'SpResourceManager',
    'DISPID_SGRSTsItem', 'SPEI_RECOGNITION', 'SAFT16kHz16BitStereo',
    'SAFTText', 'SpeechTokenKeyUI', 'DISPID_SRCEventInterests',
    'DISPID_SRGReset', 'DISPID_SGRSTsCount', 'SITooSlow',
    'DISPID_SGRClear', 'ISpNotifySource', 'DISPID_SOTs_NewEnum',
    ...
    'DISPID_SpeechVoiceStatus', 'DISPID_SMSALineId',
    'DISPID_SPPsCount', 'SPSMF_UPS', 'ISpeechAudio',
    'eLEXTYPE_PRIVATE12', 'SpeechTokenValueCLSID',
    'DISPID_SPEDisplayText', 'SAFT22kHz8BitMono', 'SVP_14',
    'SGDisplay', 'SRCS_Enabled', 'SAFT16kHz8BitMono',
    'DISPID_SPARecoResult', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRGCmdSetRuleIdState', 'SGLexical',
    'DISPID_SpeechObjectToken', 'SGSEnabled',
    'DISPID_SPIEnginePrivateData', 'SPAS_PAUSE',
    'DISPID_SLGetPronunciations', 'DISPIDSPTSI_ActiveLength',
    'ISpeechGrammarRule', 'DISPID_SRCResume', 'SPDKL_DefaultLocation',
    'DISPID_SPIEngineId', 'DISPID_SWFEBlockAlign',
    'SpeechMicTraining', 'DISPID_SDKGetBinaryValue',
    'DISPID_SLPPhoneIds', 'ISpeechRecoResult2', 'ISpNotifyTranslator',
    'DISPID_SRCBookmark', 'SVSFParseMask', 'DISPID_SGRAddResource',
    'SPPS_Noun', 'SpCompressedLexicon', 'SpeechCategoryAppLexicons',
    'ISpeechPhoneConverter', 'SVP_13', 'SpeechStreamFileMode',
    'SVEAllEvents', 'SPEI_SOUND_START', 'DISPID_SPEAudioSizeTime',
    'SpeechRecoProfileProperties', 'SPPHRASEELEMENT',
    'ISpObjectTokenCategory', 'SGPronounciation',
    'DISPID_SDKDeleteValue', 'DISPID_SpeechPhraseInfo',
    'ISequentialStream', 'SPVPRI_ALERT', 'ISpResourceManager',
    'SSTTWildcard', 'DISPID_SPRs_NewEnum', 'ISpRecoContext2',
    'SPSInterjection', 'SpInProcRecoContext',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_MIN_TTS', 'SpNotifyTranslator',
    'DISPID_SRSetPropertyString', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPAStartElementInResult', 'DISPID_SLPType',
    'DISPID_SGRsFindRule', 'DISPID_SOTCreateInstance',
    'SPFM_CREATE_ALWAYS', 'SPSEMANTICERRORINFO',
    'SPWORDPRONUNCIATIONLIST', 'SPGS_ENABLED',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SREmulateRecognition', 'SPRECOSTATE',
    'DISPID_SGRSTWeight', 'SRATopLevel', 'DISPID_SVEEnginePrivate',
    'SRTExtendableParse', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SRGId', 'SECFIgnoreWidth', 'DISPID_SGRsCommitAndSave',
    'DISPID_SpeechObjectTokens', 'DISPID_SFSClose',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRGCmdLoadFromResource', 'ISpeechCustomStream',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SABIMinNotification',
    'SpeechLexiconType', 'SSTTDictation', 'SP_VISEME_3',
